...
# SECRET = KEY1 ^ KEY2 ^ KEY3 ^ 0fc5aa9dbcc63d17b4c9ad4af7a830e1028167370ba373012ebd90e4991d7ca0538b3ea1ac
...
#SECRET = bytes_to_long(b"Exclusive or or exclusive disjunction")

#RET = SECRET ^ KEY1 ^ KEY2 ^ KEY3
#print(long_to_bytes(RET).hex())
